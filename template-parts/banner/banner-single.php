<?php 
  ...
  * Display page banner 
  */
$show_banner = singleland_opt('single_blog_banner_toggle', 'show');
$show_banner_in_page = singleland_page_meta('is_banner', get_the_ID(), 1);

$banner_url = singleland_opt('single_blog_banner_img_upload');
$banner_url_page= singleland_page_meta('banner_background_image', get_the_ID());  

$how_title = singleland_opt('is_single_blog_banner_title', 'show');
$show_breadcrumbs = singleland_opt('single_blog_banner_breadcrumb', 'show');
