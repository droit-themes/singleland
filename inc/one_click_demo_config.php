...
add_filter( 'pt-ocdi/import_files', 'singleland_import_files' );
function singleland_import_files() {
    return array(
...
function singleland_after_import_setup() {
...
add_action( 'pt-ocdi/after_import', 'singleland_after_import_setup' );